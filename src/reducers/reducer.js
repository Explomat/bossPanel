...
export default function(state = {}, action) {
	switch (action.type) {
		...
		case constants.SELECT_TESTS_RESULT_BY_PERIOD_FAILURE:
			return setFailure(state, action.error, 'testsPeriodError', 'testsFetching');
		case constants.SELECT_TESTS_RESULT_BY_PERIOD_SUCCESS:
			return setTestsPeriod(setSuccess(state, action.response, 'testsPeriodError', 'testsFetching'), action.period);
		...
		case constants.SELECT_TESTS_RESULT:
			return merge({}, state, {testsFetching: true});
		...
		case constants.SELECT_COURSES_RESULT:
			return merge({}, state, {coursesFetching: true});
		...
		case constants.SELECT_ADAPT_RESULT:
			return merge({}, state, {adaptationFetching: true});
		...
		case constants.SELECT_REQUESTS_RESULT:
			return merge({}, state, {requestsFetching: true});
		case constants.SELECT_REQUESTS_RESULT_FAILURE:
			return setFailure(state, action.error, 'requestsError', 'requestsFetching');
		case constants.SELECT_REQUESTS_RESULT_SUCCESS:
			return setSuccess(state, action.response, 'requestsError', 'requestsFetching');

		case constants.SELECT_LIBRARY_MATERIALS_PERIOD:
			return merge({}, state, {libraryMaterialsFetching: true});
